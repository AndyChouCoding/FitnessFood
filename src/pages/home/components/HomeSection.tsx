const HomeSection: React.FunctionComponent = () => {
    return (
        <>
            <section className="lg:max-w-[1200px] lg:mx-auto min-w-[600px]">
                <h2 className="text-[50px] flex justify-center mb-[10px] md:text-[30px] lg:text-[30px]">
                    Lean gains plan
                </h2>
                <div className="md:flex md:justify-center ">
                    <div className=" bg-[#D3E9E8] pb-[20px] md:w-[25%] px-[30px]">
                        ...
                        <h3 className="flex justify-center text-[30px] md:text-[12px] md:font-bold md:mb-[10px]">
                            Ideal package for:
                        </h3>
                    ...
                    <div className="bg-[#fff] md:bg-[#D3E9E8] pb-[20px] md:w-[25%] px-[30px] md:mx-[30px]">
                        <div className="flex justify-center">
                            <img
                                className="h-[350px] w-[350px] md:h-[100px] md:w-[100px] md:m-5 mt-[20px] rounded-3xl md:rounded-full "
